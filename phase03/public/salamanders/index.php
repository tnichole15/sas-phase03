...
<a href="create.php">Create New Salamanders</a>
...
<table>
  ...
  <?php while($salamander = mysqli_fetch_assoc($salamander_set)) { ?>
    <tr>
      ...
      <td>
        <a class="action" href="<?php echo url_for('/salamanders/show.php?id=' . h(u($salamander['id']))); ?>">View</a>
      </td>
      <td>
